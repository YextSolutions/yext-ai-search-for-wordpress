...
<div class="yext-wizard yext-settings" id="yext-wizard" data-step="<?php echo esc_attr( $current_step ); ?>" data-progress-id="<?php echo esc_attr( $step_progress_map[ $current_step ] ); ?>">
	...
	<div class="yext-settings__content">
